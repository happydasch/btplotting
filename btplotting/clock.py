...
class DataClockHandler:
    ...
    def _align_slice(self, slicedata, startidx=None, endidx=None, rightedge=True):
        """
            ...
            while True:
                ...
                if rightedge:
                    ...
                    if maxidx > 1:
                        if l_idx == 0:
                            c_start = c_end - (
                                slicedata["float"][1] - slicedata["float"][0]
                            )
                        else:
    ...
    def get_dt_at_idx(self, idx, localized=True):
        ...
        clk = self._clk_cache
        assert clk, "wrong"
        return bt.num2date(clk[idx], tz=None if not localized else self._tz)
    ...
    def get_dt_list(self, startidx=None, endidx=None, asfloat=False, localized=True):
        """
    ...
    def get_data(
        self, obj, startidx=None, endidx=None, fillnan=[], skipnan=[], obj_clk=None
    ):
        """
